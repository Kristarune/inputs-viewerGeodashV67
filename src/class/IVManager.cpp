...
$on_mod(Loaded) {
    // SDK 5.x: listenForSettingChanges now requires explicit type
    listenForSettingChanges<ccColor4B>("background-press-color", [](ccColor4B value) {
        IVManager::get().m_backgroundPressColor = value;
        IVSettingEvent().send(SettingEventType::Color);
    });
    listenForSettingChanges<ccColor4B>("background-release-color", [](ccColor4B value) {
        IVManager::get().m_backgroundReleaseColor = value;
        IVSettingEvent().send(SettingEventType::Color);
    });
    listenForSettingChanges<ccColor4B>("outline-press-color", [](ccColor4B value) {
        IVManager::get().m_outlinePressColor = value;
        IVSettingEvent().send(SettingEventType::Color);
    });
    listenForSettingChanges<ccColor4B>("outline-release-color", [](ccColor4B value) {
        IVManager::get().m_outlineReleaseColor = value;
        IVSettingEvent().send(SettingEventType::Color);
    });
    listenForSettingChanges<ccColor4B>("text-press-color", [](ccColor4B value) {
        IVManager::get().m_textPressColor = value;
        IVSettingEvent().send(SettingEventType::Color);
    });
    listenForSettingChanges<ccColor4B>("text-release-color", [](ccColor4B value) {
        IVManager::get().m_textReleaseColor = value;
        IVSettingEvent().send(SettingEventType::Color);
    });
