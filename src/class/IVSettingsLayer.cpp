...
SettingsLayer* SettingsLayer::create(LevelSettingsType levelType, bool enableGeodeSettingButton) {
    ...
    // SDK 5.x: Popup::init(width, height) replaces initAnchored
...
// SDK 5.x: init replaces setup; call Popup::init first
bool SettingsLayer::init(bool enableGeodeSettingButton) {
    if (!Popup::init(350.f, 260.f, "square02_001.png"))
        return false;
